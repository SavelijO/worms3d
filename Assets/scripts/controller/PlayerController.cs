...
public class PlayerController : MonoBehaviour
{
    ...
    {
        //Sprinting
        if (Input.GetKey(KeyCode.LeftShift) && !Input.GetKey(KeyCode.S) && !isCrouching && jumpingSprint && controller.velocity.magnitude > 1)
        {
            camera.fieldOfView = Mathf.Lerp(camera.fieldOfView, runFOV, walkToRunFovTime * Time.deltaTime);
        ...
        {
            camera.fieldOfView = Mathf.Lerp(camera.fieldOfView, initFov, runToBackwardsFovTime * Time.deltaTime);
        ...
        {
            camera.fieldOfView = Mathf.Lerp(camera.fieldOfView, initFov, runToCrouchFovTime * Time.deltaTime);
        ...
        {
            camera.fieldOfView = Mathf.Lerp(camera.fieldOfView, initFov, runToWalkFovTime * Time.deltaTime);
        ...
        {
            camera.fieldOfView = Mathf.Lerp(camera.fieldOfView, initFov, runToStandstillFovTime * Time.deltaTime);
        }
    }
